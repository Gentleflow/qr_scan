              ...
              binaryRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar
{
    if ([super init]) {
        ...
        _viewId = viewId;
        NSString *channelName = [NSString stringWithFormat:@"tech.gentleflow.qr_scan.reader_view_%lld", viewId];
...
@implementation QrScanViewFactory{
    NSObject<FlutterPluginRegistrar>* _registrar;
}
...
- (NSObject<FlutterPlatformView>*)createWithFrame:(CGRect)frame
                                   viewIdentifier:(int64_t)viewId
                                        arguments:(id _Nullable)args
{
    QrScanViewController* viewController = [[QrScanViewController alloc] initWithFrame:frame
